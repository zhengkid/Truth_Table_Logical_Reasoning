...
# General parameters
# Model and Datasets
BASE_MODEL="TongZheng1999/PF_gemma-2-9b-it-s1" #"TongZheng1999/FL_gemma-2-2b-it-s1" #"TongZheng1999/gemma-2-9b-it-s1" #"Qwen/Qwen2.5-7B-Instruct" #"TongZheng1999/gemma-2-9b-it-star-mixed_direct-OP-final_v1_10-2-3Rounds-iter-3" #"google/gemma-2-9b-it"
DATASET="TongZheng1999/ProofWriter" #"yale-nlp/FOLIO" #"TongZheng1999/ProofWriter"
DATASET_NAME="FL"
