...
do
  ...
  for MODE in "${MODES[@]}"; do
    ...
    HF_DATA_ID="${MODEL_NAME}_${MODE}_${STRAREGY}_rationale_${N_SAMPLES}_${PROMPT_MODE}_${NUM_CANDIDATES_GENERATE}_${EPOCHS}_${N_ROUNDS}Rounds_round_${round}"
  ...
  ITER_YAML_DIR="$RECIPE_DIR/${MODEL_NAME}_mixed_${MIXTURE_MODE}_star_training"
