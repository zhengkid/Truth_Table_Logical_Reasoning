...
# General parameters
# Model and Datasets
BASE_MODEL="TongZheng1999/gemma-2-9b-it-FL-Final" #"google/gemma-2-9b-it" #"TongZheng1999/gemma-2-9b-it-s1" #"Qwen/Qwen2.5-7B-Instruct" #"TongZheng1999/gemma-2-9b-it-star-mixed_direct-OP-final_v1_10-2-3Rounds-iter-3" #"google/gemma-2-9b-it"
DATASET="yale-nlp/FOLIO" #"TongZheng1999/ProofWriter-600" #"TongZheng1999/ProofWriter"
DATASET_NAME="FL_NL_ONLY"
